...
function buildCleanMainPrompt(product, { sellingPoints = '', mainTitle = '' } = {}) {
  ...
  // 品牌一律放「最上方、主標題之上」，一眼可見、建立信任感。
  let brandTop
  if (product.brand === LOCKNLOCK_BRAND) {
    brandTop =
      '在畫面「最上方、主標題的上面」清楚放上「樂扣樂扣 Lock&Lock」品牌標誌字樣（若我有一併上傳 logo 圖，請直接使用我的 logo），字樣乾淨專業、一眼可見，建立品牌信任感。'
  } else if (product.brand === PEARL_BRAND) {
    brandTop =
      '在畫面「最上方、主標題的上面」放上我一併上傳的「珍珠金屬 PEARL LIFE」品牌 logo，清晰、比例自然、不變形，建立品牌信任感。'
  } else {
